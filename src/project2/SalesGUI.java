...
//Remove rows one by one from the end of the table
    ...
    private void initComponents() {
        ...
        TodaySalesField = new javax.swing.JTextField();
        jLabel19 = new javax.swing.JLabel();
        TOSalesField = new javax.swing.JTextField();
        ...
        jLabel17.setBounds(290, 90, 350, 20);

        jCheckBox1.setBackground(new java.awt.Color(255, 255, 255));
        jCheckBox1.setText("show only return dates on today");
        jCheckBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox1ActionPerformed(evt);
            }
        });
        cheques.add(jCheckBox1);
        jCheckBox1.setBounds(330, 160, 220, 23);
        ...
        jLabel10.setText("Monthly Sales by me       Rs.");

        SalesField.setEditable(false);

        jLabel18.setText("Today Sales by me          Rs.");

        TodaySalesField.setEditable(false);

        jLabel19.setText("Total Overall Sales         Rs.");

        TOSalesField.setEditable(false);

        jLabel20.setText("Sales Contribution Ratio");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(SalesField, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                    .addComponent(TodaySalesField)
                    .addComponent(TOSalesField)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(TOSalesField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel18)
                    .addComponent(TodaySalesField, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(RatioField, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//PreparedStatement ps=conn.prepareStatement("Select DateAdd(d,DateDiff(dd,0,[BDate])-DatePart(dd,[BDate])+1,0), Sum( TOTPRICE )as SUM1 From Bill Group By DateAdd(dd,DateDiff(dd,0,[BDate])-DatePart(dd,[BDate])+1,0)");
            ...
            if (rs2.next()) {
                ...
                //Setting today sales of cashier
            PreparedStatement ps3 = conn.prepareStatement("SELECT SUM(TOTPRICE) AS TSALES FROM HARD.BILL WHERE BDATE=? and USER_ID=1 ");
            

            ps3.setDate(1, java.sql.Date.valueOf(java.time.LocalDate.now()));
            ...
            if (rs3.next()) {
                ...
                TodaySalesField.setText(rs3.getString("TSALES"));
                 ...
                 //Setting today sales 
            PreparedStatement ps4 = conn.prepareStatement("SELECT SUM(TOTPRICE) AS TSALES FROM HARD.BILL WHERE BDATE=?  ");
            

            ps4.setDate(1, java.sql.Date.valueOf(java.time.LocalDate.now()));
            ...
            if (rs4.next()) {
                ...
                TOSalesField.setText(rs4.getString("TSALES"));
                

            }
            
            
                     //Setting today sales  ratio 
                     
                     double ratio= (Double.valueOf(TOSalesField.getText())/Double.valueOf(TodaySalesField.getText()))*100;
          

            

                RatioField.setText(String.valueOf(ratio));
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        String search=jTextField1.getText().toString().toLowerCase();
  ...
  com.itextpdf.text.Font redFont = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 17,
            com.itextpdf.text.Font.UNDERLINE|com.itextpdf.text.Font.BOLD ,BaseColor.RED);
        
         
        if(cheqTable.getRowCount()==0){
        ...
        String title=dateFormat.format(date);
            ...
            PdfWriter.getInstance(doc, new FileOutputStream("Cheque Report- "+title+".pdf"));
            doc.open();
            
            //adding table headers
            
                 Paragraph paragraph = new Paragraph("Returning Cheques",redFont);
                paragraph.setAlignment(Element.ALIGN_CENTER);
                 doc.add(paragraph);
                 doc.add(new Phrase("\n"));
                 
            PdfPTable pdfTable = new PdfPTable(cheqTable.getColumnCount());
            for (int i = 0; i < cheqTable.getColumnCount(); i++) {
                pdfTable.addCell(cheqTable.getColumnName(i));
            }
            //extracting data from the JTable and inserting it to PdfPTable
            for (int rows = 0; rows < cheqTable.getRowCount() ; rows++) {
                for (int cols = 0; cols < cheqTable.getColumnCount(); cols++) {
                    pdfTable.addCell(cheqTable.getModel().getValueAt(rows, cols).toString());

                }
            }
            doc.add(pdfTable);
            doc.close();
           JOptionPane.showMessageDialog(this, "Succesfully Genarated");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        String searchD1=dateFormat.format(date);
        
        DefaultTableModel table=(DefaultTableModel)cheqTable.getModel();
       // String searchD=jTextField1.getText().toString().toLowerCase();
        TableRowSorter <DefaultTableModel> tr= new TableRowSorter <DefaultTableModel>(table);
        cheqTable.setRowSorter(tr);
        tr.setRowFilter(RowFilter.regexFilter(searchD1));  
        }
        else{
         DefaultTableModel table=(DefaultTableModel)cheqTable.getModel();
       String searchD=jTextField1.getText().toString().toLowerCase();
        TableRowSorter <DefaultTableModel> tr= new TableRowSorter <DefaultTableModel>(table);
        cheqTable.setRowSorter(tr);
        tr.setRowFilter(RowFilter.regexFilter(searchD)); 
        }
    ...
    private javax.swing.JTextField TOSalesField;
    private javax.swing.JTextField TodaySalesField;
